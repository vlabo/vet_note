...
type PatientTemplate struct {
	...
	Folder      func() null.Val[decimal.Decimal]
	IndexFolder func() null.Val[decimal.Decimal]
...
func (o PatientTemplate) toModel() *models.Patient {
	...
	if o.IndexFolder != nil {
		m.IndexFolder = o.IndexFolder()
	}
	if o.CreatedAt != nil {
...
func (o PatientTemplate) BuildSetter() *models.PatientSetter {
	...
	if o.Folder != nil {
		m.Folder = omitnull.FromNull(o.Folder())
	}
	if o.IndexFolder != nil {
		m.IndexFolder = omitnull.FromNull(o.IndexFolder())
	}
	if o.CreatedAt != nil {
...
func (m patientMods) RandomizeAllColumns(f *faker.Faker) PatientMod {
	return PatientModSlice{
		...
		PatientMods.RandomFolder(f),
		PatientMods.RandomIndexFolder(f),
...
// Set the model columns to this value
func (m patientMods) Folder(val null.Val[decimal.Decimal]) PatientMod {
	return PatientModFunc(func(o *PatientTemplate) {
		o.Folder = func() null.Val[decimal.Decimal] { return val }
	})
}

// Set the Column from the function
func (m patientMods) FolderFunc(f func() null.Val[decimal.Decimal]) PatientMod {
	return PatientModFunc(func(o *PatientTemplate) {
		o.Folder = f
	})
}
...
// Clear any values for the column
func (m patientMods) UnsetFolder() PatientMod {
	return PatientModFunc(func(o *PatientTemplate) {
		o.Folder = nil
	})
}
...
// Generates a random value for the column using the given faker
// if faker is nil, a default faker is used
func (m patientMods) RandomFolder(f *faker.Faker) PatientMod {
	return PatientModFunc(func(o *PatientTemplate) {
		o.Folder = func() null.Val[decimal.Decimal] {
			if f == nil {
				f = &defaultFaker
			}
...
// Set the model columns to this value
func (m patientMods) IndexFolder(val null.Val[decimal.Decimal]) PatientMod {
	return PatientModFunc(func(o *PatientTemplate) {
		o.IndexFolder = func() null.Val[decimal.Decimal] { return val }
	})
}

// Set the Column from the function
func (m patientMods) IndexFolderFunc(f func() null.Val[decimal.Decimal]) PatientMod {
	return PatientModFunc(func(o *PatientTemplate) {
		o.IndexFolder = f
	})
}
...
// Clear any values for the column
func (m patientMods) UnsetIndexFolder() PatientMod {
	return PatientModFunc(func(o *PatientTemplate) {
		o.IndexFolder = nil
	})
}
...
// Generates a random value for the column using the given faker
// if faker is nil, a default faker is used
func (m patientMods) RandomIndexFolder(f *faker.Faker) PatientMod {
	return PatientModFunc(func(o *PatientTemplate) {
		o.IndexFolder = func() null.Val[decimal.Decimal] {
			if f == nil {
				f = &defaultFaker
			}
